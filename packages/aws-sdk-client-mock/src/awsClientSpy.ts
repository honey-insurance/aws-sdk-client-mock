...
import {match, SinonSpy, SinonSpyCall} from 'sinon';
import {spyClient} from './spyClient';
import {AwsCommand} from './types';
...
export class AwsSpy<TInput extends object, TOutput extends MetadataBearer, TConfiguration>  {
    ...
    reset(): AwsSpy<TInput, TOutput, TConfiguration> {
         ...
         */
        const newStub = spyClient(this.client);
    ...
    protected createInputMatcher<TCmdInput extends TInput>(input?: Partial<TCmdInput>, strict = false) {
